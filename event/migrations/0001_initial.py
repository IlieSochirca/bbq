    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drinks', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='EventDrink', to='event.Drink')),
                ('food', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='EventFood', to='event.Food')),
            ],
        ),
    ]
